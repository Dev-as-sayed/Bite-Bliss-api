...
const UpdateFood = () => {
    ...
    const {_id} = useParams();
    const foodFindById = useFindFoodForDetail(_id);
    const axiousSecure = useAxiosSecure();
    const url = `/updateFod/${_id}`;
                    ...
                    <form onSubmit={handelUpdateFood}>
                        <div className=" lg:flex gap-8">
                            <div>
                                ...
                                <div className="relative my-4">
                                    <input type="text" name="foodCategory" defaultValue={foodFindById.foodCategory} required className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
                                ...
                                <div className="relative my-4">
                                    <input type="number" name="offer" defaultValue={foodFindById.offer} className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
                                ...
                                <div className="relative my-4">
                                    <input type="number" name="previousPrice" defaultValue={foodFindById.previousPrice} required className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
                            ...
                            <div>
                                <div className="relative my-4">
                                    <input type="text" name="resturantName" defaultValue={foodFindById.resturantName} required className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
                                ...
                                <div className="relative my-4">
                                    <input type="text" name="foodImage" defaultValue={foodFindById.foodImage} required className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
                                ...
                                <div className="relative my-4">
                                    <input type="number" name="quantity" required defaultValue={foodFindById.quantity} className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
                                    <label className="absolute text-sm text-white duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Quantity</label>
                                    <MdOutlineProductionQuantityLimits className="absolute top-4 right-4"/>
                                </div>
                                <div className="relative my-4">
                                    <input type="number" name="currentPrice" defaultValue={foodFindById.currentPrice} required className="block w-72 py-2.5 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
